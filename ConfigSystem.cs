...
namespace Plascencia
{
    public static class Paper
    {
        public const string FolderName = "SaltAdjustments";//this is the name of the folder, you can have multiple configs in a folder just fine
        public const string FileName = "Plascencia";//this is the file name, change the file name for each config
